...
const Header = () => {
    ...
    return (
        <header className='flex justify-between w-full p-4 md:py-1 md:px-6 mt-4'>
            ...
            {!user?.user.isPremium && (
                // <NavLink to={"/checkout"}>
                <button onClick={() => checkoutHandler(2000)} className="text-yellow-800 text-2xl hover:text-yellow-500 font-semibold">
                    Buy Premium
                </button>
                // </NavLink>
            )}
